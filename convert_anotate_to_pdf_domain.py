...
################################################################################################
""" convert_anotate_to_pdf.py: starts with iqtree output, converts to basic nexus
    anotates and colors the tips, anotates the phylogeny,converts to pdf """
###############################################################################################
...
from figtree_util.pdf_util import pdfmerge, pdf_anotate_single
from figtree_util.nexus_to_nexusfigtree import SeqidAnot, parse_figtree_config, parse_nexus_newick, write_nexus_figtree
from figtree_util.collapse import reanotate_nexus
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog='convert_anotate_to_pdf_domain.py',
    ...
    if not args.annotation:
        print("No annotation file provided, following the figtree configuration")
    ...
    seqidanot = SeqidAnot(args.annotation)

    seqidanot.set_merge(args.merge_pdf, args.pdf_annotations)
    print(seqidanot.merge)
